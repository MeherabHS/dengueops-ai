...
|--------|---------|-----------|
| Supply Depletion Horizon (SDH) | Current Stock / Dynamic Daily Demand | CRITICAL: ≤7d; WARNING: ≤14d |
| Projected Bed Load | Occupied Beds + (Daily Surge Cases × Avg LOS) | Bed Gap = Total Beds − Projected Load |
| Priority Score | Forecast Risk Score × (1 + Vulnerability Weight) | Higher = higher preparedness priority |
| Growth Factor | Forecast Cases / Baseline Mean Cases | >2.0 = Critical threshold |

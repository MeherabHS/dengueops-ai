...
export const metadata: Metadata = {
  ...
  description:
    "Full analytical methodology for DengueOps AI: lag-aware feature engineering, temporal backtesting, RMSE-based uncertainty, spatial exposure allocation, SDH supply depletion, LOS bed pressure, vulnerability-gated priority scoring, and human-in-the-loop directives.",
};

...
export const metadata = {
  ...
  description:
    "Converting lag-aware dengue forecasts into supply depletion timelines, bed pressure estimates, uncertainty scenarios, and public health action priorities. IEEE ICADHI 2026.",
};

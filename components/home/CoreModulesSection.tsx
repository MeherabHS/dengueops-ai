...
const MODULES = [
  {
    ...
    desc: "Uses 14- and 28-day climate lags, case trends, and seasonality to generate short-term dengue risk forecasts using a GradientBoostingRegressor trained on engineered weekly features.",
  ...
  },
  {
    ...
    desc: "Shows best, expected, and worst-case scenarios using RMSE-derived prototype uncertainty bands. Not a calibrated probabilistic interval — explicitly disclosed.",

  ...
  return (
    <section id="validation" className="mb-14">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 mb-8">
        {[
          { label: "Validation Design", value: "Chronological holdout (final 20%)" },
      ...
      <div className="flex items-start gap-3 rounded-xl border border-sky-200 bg-sky-50 px-5 py-4 mb-4">
        ...
        <div>
          ...
          <p className="text-xs text-sky-700 leading-relaxed">
            ...
            {models.find(m => m.is_selected)?.mae.toFixed(1) ?? "47.0"}) and RMSE under chronological validation —
            {improvementVsNaive}% lower MAE than the naive baseline.
            The model is not claimed as novel; it is used as a practical tabular forecasting
            component appropriate for the engineered feature matrix.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50 px-5 py-4">
        <p className="text-xs font-semibold text-amber-800 mb-2">Validation methodology notes</p>

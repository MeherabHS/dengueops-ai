...
const LIMITATIONS = [
  ...
  },
  {
    ...
    desc: "Best/worst-case scenarios are RMSE-derived planning bands. Coverage probability is unknown; residuals are not Gaussian. This is not a calibrated prediction interval.",
  },
  {

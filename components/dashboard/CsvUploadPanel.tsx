        ...
        <div className="border-t border-slate-200 px-5 py-5 space-y-6">
          ...
          {bothUploaded && (
            ...
            >
              ...
              <span>
                {bothValid
                  ? "Both files pass schema validation. Ready to run through the Python analytics pipeline."
                  : "One or more files have schema errors. Correct missing columns before running the pipeline."}
              </span>
            </div>
          )}

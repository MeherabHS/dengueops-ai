...
export default function OperationalCommandView({
  ...
  const sc = forecast.uncertainty_scenarios[scenario];
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <SectionHeader
          title="Forecast Uncertainty Scenarios"
          subtitle="Best-case, expected, and worst-case case projections for the 14-day horizon."
        />

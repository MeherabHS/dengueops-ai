...
const STEP_LABELS: Record<string, string> = {
  ...
  forecast_model:        "Forecast Model (GradientBoostingRegressor, 14d)",
  uncertainty_engine:    "Uncertainty Engine (RMSE-based scenario bands)",
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 px-4 py-2.5 text-xs text-amber-800">
        ...
        <p>
          Pipeline Step 1 generates controlled synthetic Dhaka South demo data (dengue cases + climate, 2024–2026).
          All facility and spatial layers are also synthetic. Optional OpenDengue/NASA POWER real-data pathways are available via

...
const MODEL_DISPLAY: Record<string, { label: string; role: string; color: string }> = {
  ...
  gradient_boosting:  { label: "GradientBoostingRegressor", role: "Primary ML", color: BRAND.cyan },
};
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-sky-200 bg-sky-50 px-4 py-3 flex items-start gap-3">
        ...
        <p className="text-xs text-sky-800 leading-relaxed">
          ...
          GradientBoostingRegressor was selected because it achieved the lowest
      ...
      <div>
        ...
        <p className="text-[11px] text-slate-400 mb-3">
          GBR achieves {Math.round((1 - vm.metrics.gradient_boosting.mae / vm.metrics.naive.mae) * 100)}%
